...
@app.route('/')
def home():
    return("Flaskwrd server for querying from your passwd and group files. Passwd file: {}, group file: {}\n".format(passwd_file, group_file))
...
def parse_group(name='.*', gid='.*', member='.*'):
    try:
        ...
        flask.abort(500, "Group file does not exist")
